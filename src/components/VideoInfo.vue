      ...
      <div>
        ...
        <div class="space-y-3">
          ...
          <div class="flex justify-between">
            ...
            <span class="text-sm font-medium text-gray-900 truncate ml-2" :title="videoData.name">
              {{ videoData.name }}
            </span>
          </div>
          ...
          <div class="flex justify-between">
            ...
            <span class="text-sm font-medium text-gray-900">{{ formatFileSize(videoData.size) }}</span>
          </div>
          
          <!-- File Type -->
          <div class="flex justify-between">
            <span class="text-sm text-gray-600">Format:</span>
            <span class="text-sm font-medium text-gray-900">{{ videoData.type || 'Unknown' }}</span>
          </div>
          ...
          <div class="flex justify-between">
            ...
            <span class="text-sm font-medium text-gray-900">
              {{ metadata.duration ? formatDuration(metadata.duration) : 'Loading...' }}
            </span>
          </div>
          ...
          <div class="flex justify-between">
            ...
            <span class="text-sm font-medium text-gray-900">
              {{ metadata.width && metadata.height ? `${metadata.width} × ${metadata.height}` : 'Loading...' }}
            </span>
          </div>
        ...
        <!-- Processing Status -->
        <div v-if="isLoading" class="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
...
const handleVideoError = () => {
  error.value = 'Failed to load video. The file may be corrupted or in an unsupported format.'
  isLoading.value = false
}
