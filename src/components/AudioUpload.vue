  ...
  <div class="bg-white rounded-lg shadow-md p-6">
    ...
    >
      ...
      <div v-if="!selectedFile" class="text-gray-500">
        ...
        <p class="text-xs text-gray-400 mt-2">MP3, WAV, M4A, OGG, FLAC supported (max 100MB)</p>
      </div>
...
const SUPPORTED_TYPES = [
  ...
  'audio/mp4', 'audio/m4a', 'audio/ogg', 'audio/flac', 'audio/x-flac'
]
...
const handleAudioError = () => {
  errorMessage.value = 'Failed to load audio file. The file may be corrupted or in an unsupported format.'
}
